var swiper = new Swiper(".slide-content", {
  ...
  function sendEmail(){
      ...
      message: user_message
          ...
          emailjs.send('service_2llb33m', 'template_gwcv1cj', templateParams)
...
// for humberger toggle button
    ...
    function toogleMenu(){
      ...
      if(tgl == false){
        ...
        nav.style.right = "-100%";
        micon.setAttribute("src", "./images/icons/MenuIcon.svg");
        tgl = !tgl;
            ...
            micon.setAttribute("src", "./images/icons/closeMenu.svg");
            nav.style.right = "0";
            tgl = !tgl;
